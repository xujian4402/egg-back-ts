...
Interface.getUserByCode = function (code) {
    return this.request(this.getApiURI('oauth', 'getUserByCode'), this.getSignature({code: code}));
};
...
Interface.createMenu = function (menu) {
    return this.send(this.getApiURI('mp', 'createMenu'), this.getSignature({menu: menu}));
};
...
Interface.wxpayValidate = function (xmlBody) {
    return this.send(this.getApiURI('pay', 'wxpayValidate'), this.getSignature({xmlBody: xmlBody}));
};
...
Interface.wxpayResultSign = function (xmlBody) {
    return this.send(this.getApiURI('pay', 'wxpayResultSign'), this.getSignature({xmlBody: xmlBody}));
};
...
Interface.getBrandWCPayRequestParams = function (order) {
    return this.send(this.getApiURI('pay', 'getBrandWCPayRequestParams'), this.getSignature({order: order}));
};
...
Interface.getCard = function (card_id, openid) {
    return this.send(this.getApiURI('card', 'getCard'), this.getSignature({card_id: card_id, openid: openid}));
};
...
Interface.uploadLogo = function (filepath) {
    return this.send(this.getApiURI('card', 'uploadLogo'), this.getSignature({filepath: filepath}));
};
...
Interface.getQueryAuth = function (auth_code) {
    return this.request(this.getApiURI('auth', 'add', 'mod'), this.getSignature({auth_code: auth_code, type: 'json'}));
};
